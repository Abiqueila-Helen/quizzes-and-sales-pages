...
<html lang="en">
  ...
  <body>
    <div class="card">
      ...
      <p>Algo deu errado por nossa conta. Você pode tentar atualizar a página ou voltar para a página inicial.</p>
      <div class="actions">
...
async function getServerEntry() {
	if (!serverEntryPromise) serverEntryPromise = import("./server-OoGl9_Rc.mjs").then((m) => m.default ?? m);
