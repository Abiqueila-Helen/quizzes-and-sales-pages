# Tarefa: Colocar script de pixel do facebook nas duas novas páginas de vendas

## Objetivo

Nós colocamos esses dois script no header da página com rota '/appsre':
...
Agora preciso que você coloque para funcionar exatamente os mesmos dois script nas novas páginas de vendas. Cada página precisa ter os dois scripts no header. Essas são as rotas das novas páginas que você precisa colocar:

- rota '/ressignifica-app-sell'
- rota '/ressignifica-app-sell-pie'